...
"""
TODO auto replace chain for all nodes when mine is complete
TODO auto add all nodes on init
TODO transactions from other nodes arent added when mining
TODO everything exists only in memory
"""
